...
Route::group(['prefix' => $adminPrefix], function() {
    ...
    Route::group(['prefix' => 'brand-data'], function() {
        Route::get('brand',[BrandController::class, 'brandList'])->name('admin.brand-data.brand');
        Route::get('add-brand',[BrandController::class, 'addbrand'])->name('admin.brand-data.add-brand');
        Route::post('storebrand',[BrandController::class, 'storebrand'])->name('admin.brand-data.storebrand');
